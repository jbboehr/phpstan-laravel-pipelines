...
assertType('Illuminate\Pipeline\Pipeline<array<int, (callable(): mixed)|object>, string, mixed>', $pipeline);

$pipeline->via('handle');

assertType("Illuminate\Pipeline\Pipeline<array<int, (callable(): mixed)|object>, 'handle', mixed>", $pipeline);

$pipeline->send(1);

assertType("Illuminate\Pipeline\Pipeline<array<int, (callable(): mixed)|object>, 'handle', 1>", $pipeline);
