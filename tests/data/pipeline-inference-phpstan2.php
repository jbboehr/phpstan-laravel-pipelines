...
assertType('Illuminate\Pipeline\Pipeline<list<(callable(): mixed)|object>, string, mixed, mixed>', $pipeline);

$pipeline->via('handle');

assertType("Illuminate\Pipeline\Pipeline<list<(callable(): mixed)|object>, 'handle', mixed, mixed>", $pipeline);

$pipeline->send(1);

assertType("Illuminate\Pipeline\Pipeline<list<(callable(): mixed)|object>, 'handle', 1, mixed>", $pipeline);
